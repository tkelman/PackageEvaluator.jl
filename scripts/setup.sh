...
then
    wget -O julia.tar.gz https://julianightlies.s3.amazonaws.com/bin/linux/x64/0.5/julia-0.5.0-65b892747d-linux64.tar.gz
else
    # Nightly
...
if [ "$1" == "0.3" ]
then
    LOOPOVER=/home/vagrant/.julia/v0.5/METADATA/[A-F]*
elif [ "$1" == "0.4" ]
then
    LOOPOVER=/home/vagrant/.julia/v0.5/METADATA/[G-N]*;
elif [ "$1" == "0.5" ]
then
    LOOPOVER=/home/vagrant/.julia/v0.5/METADATA/[O-Z]*;
fi
